...
$turmas = array();
$sql = "SELECT T.id_turma, T.dt_inicio, T.dt_termino, T.qtd_vagas, T.qt_cartao FROM tb_turma T INNER JOIN tb_curso C ON T.id_curso = C.codigo WHERE T.id_curso = ".$id_curso."";
