...
$(document).ready(function(){
    ...
    $.ajax({
        type: "POST",
        url: "/wp-content/themes/Site/php/check-user-compra.php",
        dataType: 'json',
...
$(document).ready(function() {
    ...
    $('form.enter-login').validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "POST",
                url: "/wp-content/themes/Site/php/checkuser.php",
                data: dados,
                success: function(response) {
    ...
    $('form.singUp').validate({
        rules: {
            ...
            email: {
                ...
                email: true,
                remote: {
                    url: "/wp-content/themes/Site/php/check-exists-mail.php",
                    type: "post",
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "POST",
                url: "/wp-content/themes/Site/php/cadastrar-aluno.php",
                data: dados,
                success: function(data) {
                    $("#myModal").modal('hide');
    ...
    $("form.recuperar-senha").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "POST",
                url: "/wp-content/themes/Site/php/recover-password.php",
                data: dados,
                success: function(data) {
                    $("#myModal3").modal('hide');
    ...
    $("form.redefinir-senha").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "POST",
                url: "/wp-content/themes/Site/php/reset-password.php",
                data: dados,
                success: function(data) {
                    if (data == "true") {
...
$("#frmLogin").submit(function(e){
    ...
    $.post('/wp-content/themes/Site/php/checkuser.php', $("#frmLogin").serialize(), function(data){
        ...
        $.ajax({
            url: '/wp-content/themes/Site/php/jwt-test/public/0auth.php',
            type: 'POST',
            data: {
                codigo:     _codigo,
...
function fecharPedido(senderHash) {
    ...
    if(formAluno.data("cadastrado") == "sucesso") {
        ...
        //alert("Informe Corretamente os dados do seu cartão de crédito");
            ...
            valorCurso = parseFloat(atob($(".product-all-track").find("aside.track-0").attr("data-track")));
            valorParcela = valorCurso / parcelas;

            // console.log(valorParcela);
            $.ajax({
                type: 'POST',
                url: '/wp-content/themes/Site/pagseguro/pagamentoCartao.php',
                cache: false,
                data: {
                ...
                success: function(data) {
                    ...
                    if (data.error) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '/wp-content/themes/Site/php/cadastrar-compra.php',
                            cache: false,
                            data: {
...
function pagarBoleto(senderHash) {
    var valorCurso = parseFloat(atob($(".product-all-track").find("aside.track-0").attr("data-track")));
    var formAluno = $("#formCadastroAluno");
    ...
    if(formAluno.data("cadastrado") == "sucesso") {
        $.ajax({
            type: 'POST',
            url: '/wp-content/themes/Site/pagseguro/pagamentoBoleto.php',
            cache: false,
            data: {
                usuario: $('.js-codigo').val(),
                // email: $('.js-email').val(),
