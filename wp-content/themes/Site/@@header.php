...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<? bloginfo('template_url') ?>/css/owl.carousel.css">
        <link rel="stylesheet" type="text/css" href="<? bloginfo('template_url') ?>/css/owl.theme.css">
    </head>
    <body>
    <header>
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      ...
			      <ul class="nav navbar-nav">
			        <li><a class="ancora" href="<? bloginfo('url') ?>/"><p>Home</p></a></li>
			        <li><a class="ancora" href="<? bloginfo('url') ?>/quem-somos/"><p>Quem Somos</p></a></li>
			        <li><a class="ancora" href="<? bloginfo('url') ?>/servicos/"><p>Serviços</p></a></li>
			        <li><a class="ancora" href="<? bloginfo('url') ?>/cursos-e-consultoria/"><p>Cursos</p></a></li>
			        <li><a class="ancora" href="<? bloginfo('url') ?>/inscreva-se/"><p>Inscreva-se</p></a></li>
			        <li><a class="ancora noborder" href="<? bloginfo('url') ?>/contato/"><p>Contatos</p></a></li>
			        <div class="right_buttons hidden-xs">
				        <!-- <a href="<? bloginfo('url') ?>/contato/"><li><span class="btn-tel"></span></li></a> -->
				        <?
                            // if(!session_init()) : 
                            //     echo "Sessão Falhou";
                            // else :
                            ...
                            if($wp_session['UserID'] == null) :
                                ...
                                echo '<li><a href="http://lisieuxtreinamento.com.br/logout"><span class="btn-login"></span></a></li>';
        ...
        <div class="singUp">
        	<form class="singUp">
                ...
                <div class="inpt col-xs-12 col-md-6">
                    ...
                    <input type="text" name="cpf col-md-8" onkeypress="return MascaraTel(this, '999.999.999-99', event);" required="required" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="Digite o CPF no formato xxx.xxx.xxx-xx" maxlength="14">
                </div>
        		<div class="inpt col-xs-12 col-md-6">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content final-mail">
      <div class="modal-body">
        ...
        <img class="img-responsive" src="<? bloginfo('template_url') ?>/images/mail.jpg">
        <a href="<? bloginfo('url') ?>/">
